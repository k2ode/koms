...
func MakeContainer(conversations ComponentConversations, messages MessagesComponent, containerInput ComponentInputContainer, preview ComponentPreview) *tview.Grid {
